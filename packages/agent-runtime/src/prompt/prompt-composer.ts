    ...
    return [
      {
        ...
        content: [
          ...
          'Format final responses as Markdown: keep prose as normal text and put source code in fenced code blocks with a language tag. Never emit ANSI terminal control sequences in the response.',
